 ...
 * 
 * /lib/pong:
 *  pong-clientManager.js   -- Common Entrypoint; processes ready sockets/clients, pushes
 ...
 *  pongGame-server.js      -- Takes two sockets and mediates their Game. Processes client 
 *                              window boundaries to ensure synchronized playability / viewing
 *  screenManager.js        -- Calculates the window boundaries described above
 *  pongGame.js             -- Sublet of pG-server.js; calculates game-state (collisions, score, etc.)
 *  generatePongConstants.js-- Self-descriptive; Generates Game Objects/Assets from the window boundaries
